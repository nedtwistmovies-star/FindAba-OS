        ...
        <AnimatePresence mode="wait">
          {loading ? (
            ...
            >
              ...
              <p className="text-sm font-black uppercase tracking-[0.3em] text-aba-gold animate-pulse">Elder Kalu Onyendu is consulting the registry...</p>
            </motion.div>
          ) : results ? (
            <motion.div 
              ...
              <div className="bg-gradient-to-br from-aba-dark to-[#002113] p-10 rounded-[3.5rem] border border-aba-gold/20 shadow-2xl relative overflow-hidden">
                ...
                <div className="relative z-10 space-y-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="text-xl font-black uppercase tracking-tight text-white">Oracle Wisdom</h3>
                      <p className="text-[10px] font-bold text-aba-gold uppercase tracking-[0.2em]">Elder Kalu Onyendu's Industrial Insight</p>
                    </div>
                  </div>
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <p className="text-white/40 text-sm max-w-md mx-auto leading-relaxed">
                  Describe what you need, and Elder Kalu Onyendu will search the industrial registry to find the perfect master artisan for you.
                </p>
              </div>
