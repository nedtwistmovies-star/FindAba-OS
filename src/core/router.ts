...
export const ROUTE_MAP: Record<ViewState, any> = {
  ...
  support: lazyWithRetry(() => import('../features/discovery/Home')),
  orders: lazyWithRetry(() => import('../features/finance/BuyerOrdersView')),
  'dispute-center': lazyWithRetry(() => import('../features/discovery/Home')),
  ...
  'srts-dashboard': lazyWithRetry(() => import('../features/logistics/CarryGoDash')),
  ...
  'hotel-detail': lazyWithRetry(() => import('../features/discovery/Home')),
