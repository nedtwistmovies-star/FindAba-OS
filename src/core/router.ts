...
export const ROUTE_MAP: Record<string, any> = {
  ...
  'about-who': safeLazy(() => import('../features/info/About')),
  'about-vision': safeLazy(() => import('../features/info/About')),
  'about-mission': safeLazy(() => import('../features/info/About')),
  contact: safeLazy(() => import('../features/info/Contact')),
  wallet: safeLazy(() => import('../features/finance/WalletView')),
  'editorial-detail': safeLazy(() => import('../features/discovery/AdvertorialDetail')),
  'carry-me': safeLazy(() => import('../features/logistics/CarryMe')),
  'driver-console': safeLazy(() => import('../features/logistics/DriverConsole')),
  'driver-registry': safeLazy(() => import('../features/logistics/DriverRegistry')),
  'fleet-admin': safeLazy(() => import('../features/logistics/FleetAdmin')),
  'carry-go-dash': safeLazy(() => import('../features/logistics/CarryGoDash')),
  'hotel-detail': safeLazy(() => import('../features/hospitality/SandalsHotels')),
  'hotel-partner-control': safeLazy(() => import('../features/hospitality/HotelPartnerControl')),
  'srts-office': safeLazy(() => import('../features/admin/SandalsOffice'))
};
